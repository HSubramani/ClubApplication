        ...
        if(request.method=='POST'):
            try:
                ...
                if(service=="Backup Members"):
                    ...
                    try:
                        f=TackleMember.objects.get(username="Tackle").file
                        f.delete()
                        f=TackleMember.objects.get(username="Tackle")
                        f.delete()
                    except Exception:
                        pass
                    f=TackleMember.objects.create(username="Tackle",regno="Tackle",file=files)
                    f.save()
                elif(service=="Tackle Solution Upload"):
                    files=request.FILES.get('file')
                    try:
                        f=TackleMember.objects.get(username="TackleSol").file
                        f.delete()
                        f=TackleMember.objects.get(username="TackleSol")
                        f.delete()
                    except Exception:
                        pass
                    f=TackleMember.objects.create(username="TackleSol",regno="TackleSol",file=files)
                    f.save()
                else:
                    files=request.FILES.get('file')
